                ...
                <div className="flex flex-col items-center gap-12">
                    ...
                    >
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-20 h-20 rounded-full bg-orange-600 flex items-center justify-center cursor-pointer hover:scale-110 transition-transform">
                        ...
                        {articles.map((article, index) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col justify-center">
                                    <span className="text-xs text-orange-500 uppercase tracking-widest mb-2">{article.category}</span>
                                    <h4 className="text-xl font-bold group-hover:text-orange-400 transition-colors">{article.title}</h4>
                                </div>
                            </motion.div>
                        ))}
                    </div>
